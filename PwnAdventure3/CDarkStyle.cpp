...
CDarkStyle::CDarkStyle() :
	CDarkStyle(styleBase())
{
}

CDarkStyle::CDarkStyle(QStyle *style) :
	QProxyStyle(style)
{
}

QStyle *CDarkStyle::styleBase(QStyle *style) const
{
	static QStyle *base = !style ? QStyleFactory::create(QStringLiteral("Fusion")) : style;
	return base;
}

QStyle *CDarkStyle::baseStyle() const
{
	return styleBase();
}

void CDarkStyle::polish(QPalette &palette)
{
...
void CDarkStyle::polish(QApplication *app)
{
	if (!app) return;

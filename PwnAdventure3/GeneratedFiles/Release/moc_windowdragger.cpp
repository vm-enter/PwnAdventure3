...
void WindowDragger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (WindowDragger::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WindowDragger::doubleClicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject WindowDragger::staticMetaObject = {
...
void *WindowDragger::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WindowDragger.stringdata0))
        return static_cast<void*>(const_cast< WindowDragger*>(this));
